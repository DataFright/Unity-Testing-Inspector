...
New here? [USAGE.md](./USAGE.md) covers install + setup,
[READING_LOGS_AND_VISUALS.md](./READING_LOGS_AND_VISUALS.md) explains how to actually interpret
what UTI produces, and [CONFIG.md](./CONFIG.md) covers setting a game's own preferred defaults in
one place. This file is the pitch/concept; [DESIGN.md](./DESIGN.md) is the architecture.
